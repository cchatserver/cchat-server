...
var url = process.env.MONGOLAB_URL || 'mongodb://cchatuser:cchat2016@ds039165.mlab.com:39165/cchat';//'mongodb://127.0.0.1/chat'; //mongo lab url (if it's not a config var would use local)
var authyKey = process.env.AUTHY_DEV_KEY || 'tjr2LZXE1jWPToKVrdSqDJRED6hNk51M'; //provided by authy
